...
- **Status:** :yellow_circle: Pending (requires file upload)
- **Type:** Browser Test
- **Priority:** Critical
- **Created:** 2026-02-02 07:55
...
- **Status:** :yellow_circle: Pending (requires non-admin login)
- **Type:** Browser Test
- **Priority:** Medium
- **Created:** 2026-02-02 07:55
...
| 7 | Confirm signature creates deal | :yellow_circle: Pending | Requires file upload first |
...
| 10 | Admin panel hidden for non-admins | :yellow_circle: Pending | Requires non-admin login |
