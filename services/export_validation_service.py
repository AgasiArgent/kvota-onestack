...
# IMPORTANT: Must map ALL values to Excel's list_vat table values for correct VLOOKUP
# Excel list_vat has: Турция, Турция (отгрузка на транзитной зоне), ЕС (закупка между странами ЕС),
#                     Россия, Китай, Литва, Латвия, Болгария, Польша, ОАЭ, Прочие
COUNTRY_MAP = {
    # === Countries IN list_vat (passthrough) ===
    "Турция": "Турция",
    "Китай": "Китай",
    "Россия": "Россия",
    "Литва": "Литва",
    ...
    # === 2-letter codes → list_vat values ===
    "TR": "Турция",
    "CN": "Китай",
    "RU": "Россия",
    "LT": "Литва",
    ...
    # === API normalized values → Excel list_vat values ===
    # (calculation_mapper.py normalizes these for API, we map to Excel format)
    "Турция (транзитная зона)": "Турция (отгрузка на транзитной зоне)",
    "ЕС (между странами ЕС)": "ЕС (закупка между странами ЕС)",

    # === EU countries NOT in list_vat → map to "ЕС (закупка между странами ЕС)" ===
    # These countries are treated as EU cross-border in calculation_mapper.py
    # but need to map to Excel's EU entry for correct internal_markup lookup
    "Германия": "ЕС (закупка между странами ЕС)",
    "Germany": "ЕС (закупка между странами ЕС)",
    "DE": "ЕС (закупка между странами ЕС)",
    "Италия": "ЕС (закупка между странами ЕС)",
    "Italy": "ЕС (закупка между странами ЕС)",
    "IT": "ЕС (закупка между странами ЕС)",
    "Франция": "ЕС (закупка между странами ЕС)",
    "France": "ЕС (закупка между странами ЕС)",
    "FR": "ЕС (закупка между странами ЕС)",
    "Испания": "ЕС (закупка между странами ЕС)",
    "Spain": "ЕС (закупка между странами ЕС)",
    "ES": "ЕС (закупка между странами ЕС)",
    "Нидерланды": "ЕС (закупка между странами ЕС)",
    "Netherlands": "ЕС (закупка между странами ЕС)",
    "NL": "ЕС (закупка между странами ЕС)",
    "Австрия": "ЕС (закупка между странами ЕС)",
    "Austria": "ЕС (закупка между странами ЕС)",
    "AT": "ЕС (закупка между странами ЕС)",
    "Бельгия": "ЕС (закупка между странами ЕС)",
    "Belgium": "ЕС (закупка между странами ЕС)",
    "BE": "ЕС (закупка между странами ЕС)",
    "Швеция": "ЕС (закупка между странами ЕС)",
    "Sweden": "ЕС (закупка между странами ЕС)",
    "SE": "ЕС (закупка между странами ЕС)",
    "Чехия": "ЕС (закупка между странами ЕС)",
    "Czech Republic": "ЕС (закупка между странами ЕС)",
    "CZ": "ЕС (закупка между странами ЕС)",
    "Словакия": "ЕС (закупка между странами ЕС)",
    "Slovakia": "ЕС (закупка между странами ЕС)",
    "SK": "ЕС (закупка между странами ЕС)",
    "Венгрия": "ЕС (закупка между странами ЕС)",
    "Hungary": "ЕС (закупка между странами ЕС)",
    "HU": "ЕС (закупка между странами ЕС)",
    "Румыния": "ЕС (закупка между странами ЕС)",
    "Romania": "ЕС (закупка между странами ЕС)",
    "RO": "ЕС (закупка между странами ЕС)",
    "Финляндия": "ЕС (закупка между странами ЕС)",
    "Finland": "ЕС (закупка между странами ЕС)",
    "FI": "ЕС (закупка между странами ЕС)",
    "Дания": "ЕС (закупка между странами ЕС)",
    "Denmark": "ЕС (закупка между странами ЕС)",
    "DK": "ЕС (закупка между странами ЕС)",
    "Португалия": "ЕС (закупка между странами ЕС)",
    "Portugal": "ЕС (закупка между странами ЕС)",
    "PT": "ЕС (закупка между странами ЕС)",
    "Ирландия": "ЕС (закупка между странами ЕС)",
    "Ireland": "ЕС (закупка между странами ЕС)",
    "IE": "ЕС (закупка между странами ЕС)",
    "Греция": "ЕС (закупка между странами ЕС)",
    "Greece": "ЕС (закупка между странами ЕС)",
    "GR": "ЕС (закупка между странами ЕС)",
}
