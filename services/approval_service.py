...
async def request_approvals(
    ...
    Use this for ALL approval flows — guarantees notifications fire so approvers
    actually see the request. Direct callers of `create_approvals_for_role()` should
    migrate to this function unless they explicitly want INSERT-only behavior.
